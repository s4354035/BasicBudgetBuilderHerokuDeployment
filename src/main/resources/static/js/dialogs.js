    ...
    angular.module('dialogs.services',['ui.bootstrap.modal','dialogs.controllers'])
        ...
        .provider('dialogs',[function(){
            ...
            var _setOpts = function(opts){
                ...
                _opts.mobile = (angular.isDefined(opts.mobile)) ?  opts.mobile : false;
                return _opts;
            }; // end _setOpts
                ...
                return {
                    ...
                    error : function(header,msg,opts){
                        ...
                        return $uibModal.open({
                            templateUrl : opts.mobile ? '/dialogs/errorM.html' : '/dialogs/error.html',
                    ...
                    wait : function(header,msg,progress,opts){
                        ...
                        return $uibModal.open({
                            templateUrl : opts.mobile ? '/dialogs/waitM.html' : '/dialogs/wait.html',
                    ...
                    notify : function(header,msg,opts){
                        ...
                        return $uibModal.open({
                            templateUrl : opts.mobile ? '/dialogs/notifyM.html' : '/dialogs/notify.html',
                    ...
                    confirm : function(header,msg,opts){
                        ...
                        return $uibModal.open({
                            templateUrl : opts.mobile ? '/dialogs/confirmM.html' : '/dialogs/confirm.html',
...
//== Dialogs.Main Module =====================================================//
    ...
    angular.module('dialogs.main',['dialogs.services','ngSanitize']) // requires angular-sanitize.min.js (ngSanitize) //code.angularjs.org/1.2.1/angular-sanitize.min.js
        ...
        .run(['$templateCache','$interpolate',function($templateCache,$interpolate){
            ...
            $templateCache.put('/dialogs/errorM.html','<div class="dialog-mobile-3"><div class="modal-dialog"><div class="modal-content"><div class="modal-header dialog-header-error"><button type="button" class="close" ng-click="close()">&times;</button><h4 class="modal-title text-danger"><span class="'+startSym+'icon'+endSym+'"></span> <span ng-bind-html="header"></span></h4></div><div class="modal-body text-danger" ng-bind-html="msg"></div><div class="modal-footer"><button type="button" class="btn btn-default" ng-click="close()">'+startSym+'"DIALOGS_CLOSE" | translate'+endSym+'</button></div></div></div></div>');
            $templateCache.put('/dialogs/waitM.html','<div class="dialog-mobile-3"><div class="modal-dialog"><div class="modal-content"><div class="modal-header dialog-header-wait"><h4 class="modal-title"><span class="'+startSym+'icon'+endSym+'"></span> '+startSym+'header'+endSym+'</h4></div><div class="modal-body"><p ng-bind-html="msg"></p><div class="progress progress-striped active"><div class="progress-bar progress-bar-info" ng-style="getProgress()"></div><span class="sr-only">'+startSym+'progress'+endSym+''+startSym+'"DIALOGS_PERCENT_COMPLETE" | translate'+endSym+'</span></div></div></div></div></div>');
            $templateCache.put('/dialogs/notifyM.html','<div class="dialog-mobile-3"><div class="modal-dialog"><div class="modal-content"><div class="modal-header dialog-header-notify"><button type="button" class="close" ng-click="close()" class="pull-right">&times;</button><h4 class="modal-title text-info"><span class="'+startSym+'icon'+endSym+'"></span> '+startSym+'header'+endSym+'</h4></div><div class="modal-body text-info" ng-bind-html="msg"></div><div class="modal-footer"><button type="button" class="btn btn-primary" ng-click="close()">'+startSym+'"DIALOGS_OK" | translate'+endSym+'</button></div></div></div></div>');
            $templateCache.put('/dialogs/confirmM.html','<div class="dialog-mobile-3"><div class="modal-dialog"><div class="modal-content"><div class="modal-header dialog-header-confirm"><button type="button" class="close" ng-click="no()">&times;</button><h4 class="modal-title"><span class="'+startSym+'icon'+endSym+'"></span> '+startSym+'header'+endSym+'</h4></div><div class="modal-body" ng-bind-html="msg"></div><div class="modal-footer"><button type="button" class="btn btn-default" ng-click="yes()">'+startSym+'"DIALOGS_YES" | translate'+endSym+'</button><button type="button" class="btn btn-primary" ng-click="no()">'+startSym+'"DIALOGS_NO" | translate'+endSym+'</button></div></div></div></div>');
